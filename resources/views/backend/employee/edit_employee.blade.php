...
<div class="card">
    ...
    <option value="1 Year" {{ $employee->experience == '1 Year' ? 'selected' : '' }} >une année</option>
    <option value="2 Year"  {{ $employee->experience == '2 Year' ? 'selected' : '' }}>2 années</option>
    <option value="3 Year" {{ $employee->experience == '3 Year' ? 'selected' : '' }}>3 années</option>
    <option value="4 Year" {{ $employee->experience == '4 Year' ? 'selected' : '' }}>4 années</option>
    <option value="5 Year" {{ $employee->experience == '5 Year' ? 'selected' : '' }}>5 années</option>
                </select>
                 @error('experience')
      <span class="text-danger"> {{ $message }} </span>
            @enderror
