                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"> <a href="{{ route('all.roles.permission') }}" class="btn btn-danger rounded-pill waves-effect waves-light">Retour </a></li>
...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
        <form id="myForm" method="post" action="{{ route('role.permission.store') }}" enctype="multipart/form-data">
            ...
            <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Ajouter un rôle dans l'autorisation</h5>

            <div class="row">

        <div class="col-md-6">
        <div class="form-group mb-3">
            <label for="firstname" class="form-label">Tous les rôles </label>
            <select name="role_id" class="form-select" id="example-select">
         <option selected disabled >Choisir le  rôle </option>
       ...
       <div class="form-check mb-2 form-check-primary">
        ...
        <label class="form-check-label" for="customckeck15">Tout Cocher</label>
       </div>
