                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="mb-4 text-uppercase"><i class="fe-lock"></i> changer votre mot de passe</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="mb-3">
            <label for="firstname" class="form-label">Votre ancien mot de passe</label>
     ...
     <div class="col-md-12">
        <div class="mb-3">
            <label for="firstname" class="form-label">Votre nouveau mot de passe</label>
     ...
     <div class="col-md-12">
        <div class="mb-3">
            <label for="firstname" class="form-label">Confirmer votre nouveau mot de passe</label>
